...
## このハンズオン資料の使い方
AIに、この資料を渡し、
「STEP 0 から学んでいきたいから、やることを伴走してください。重要な点としては、"進め方（重要）"に書いているとおり、私が手を動かして、ハンズオンをするので勝手にコードを書かないでください。途中で色々質問するかもしれませんが、ステップのひとつが完了したら、次のステップを順番に理解できるよう解説しながら進めてください」
といってスタートしてください。
