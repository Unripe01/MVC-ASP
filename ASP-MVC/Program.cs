...
builder.Services.AddScoped<UserInfoReportDefinition>();
builder.Services.AddScoped<IReportWorkflow, UserFavoriteReportWorkflow>();
builder.Services.AddScoped<IReportWorkflow, UserInfoReportWorkflow>();
builder.Services.AddScoped<ReportWorkflowRegistry>();
builder.Services.AddScoped<ReportCatalogService>();
builder.Services.AddScoped<ReportDocumentService>();
